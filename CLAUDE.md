# Tarang — Claude Code Instructions

## Project Identity

**Tarang** (Sanskrit: wave) — AI-native media framework — audio/video decode, encode, mux, fingerprint, analysis
...
jalwa (playback), tazama (video editing), shruti (audio export), aethersafta (streaming)
